...
class SportsScreen extends StatelessWidget
{
    ...
    return BlocConsumer<AppCubit, AppStates>(
        ...
        builder: (context, state)
        {
          ...
          return Conditional.single(
              context: context,
              conditionBuilder: (context) => cubit.sports.length > 0,
  ...
  Widget buildRow(BuildContext context, int index)
  {
    ...
    if(cubit.sports[index]["urlToImage"] != null)
    {
    ...
    return InkWell(
      onTap: ()
      {
        Navigator.push(context, MaterialPageRoute(builder: (context) => WebViewScreen(cubit.sports[index]["url"])));
      },
      child: Padding(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("${cubit.sports[index]["publishedAt"]}",
                        style: Theme.of(context).textTheme.bodyText1
                    )
                  ],
                ),
